...
>(({ className, ...props }, ref) => {
	return (
		<div
			ref={ref}
			data-sidebar="header"
			className={cn('mb-2 flex flex-col gap-2 px-2 py-4', className)}
			{...props}
		/>
	);
});
